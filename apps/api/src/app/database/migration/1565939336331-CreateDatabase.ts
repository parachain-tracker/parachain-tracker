...
export class CreateDatabase1565939336331 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(
            `CREATE TABLE "Project" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "type" integer NOT NULL DEFAULT (0), "name" varchar(256) NOT NULL, "developer" varchar(256) NOT NULL, "description" text NOT NULL, "status" integer NOT NULL, "link" text NOT NULL, "stars" integer NOT NULL, "commits" integer NOT NULL, "network" varchar(32) NOT NULL, "tagline" text NOT NULL DEFAULT (''), "categoryId" integer, CONSTRAINT "REL_af6d1f6d7ab25b4fa6a1a68447" UNIQUE ("categoryId"))`,
        )
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE "temporary_Project" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "type" integer NOT NULL DEFAULT (0), "name" varchar(256) NOT NULL, "developer" varchar(256) NOT NULL, "description" text NOT NULL, "status" integer NOT NULL, "link" text NOT NULL, "stars" integer NOT NULL, "commits" integer NOT NULL, "network" varchar(32) NOT NULL, "tagline" text NOT NULL DEFAULT (''), "categoryId" integer, CONSTRAINT "REL_af6d1f6d7ab25b4fa6a1a68447" UNIQUE ("categoryId"), CONSTRAINT "FK_af6d1f6d7ab25b4fa6a1a68447c" FOREIGN KEY ("categoryId") REFERENCES "Category" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
        )
        await queryRunner.query(
            `INSERT INTO "temporary_Project"("id", "type", "name", "developer", "description", "status", "link", "stars", "commits", "network", "tagline", "categoryId") SELECT "id", "type", "name", "developer", "description", "status", "link", "stars", "commits", "network", "tagline", "categoryId" FROM "Project"`,
        )
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(
            `INSERT INTO "Project"("id", "type", "name", "developer", "description", "status", "link", "stars", "commits", "network", "tagline", "categoryId") SELECT "id", "type", "name", "developer", "description", "status", "link", "stars", "commits", "network", "tagline", "categoryId" FROM "temporary_Project"`,
        )
